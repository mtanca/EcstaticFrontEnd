 ...
 */
export default class HomeScreenNew extends React.Component {
  constructor(props) {
    super(props);
      ...
      <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
        {this.props.hasData &&
          this.props.data.giveaways.map(giveaway => (
            <View style={{flex: 1, marginLeft: 5}} key={giveaway.id}>
              <TouchableHighlight onPress={() => this._navigate(giveaway)}>
                <Image source={this.getImage(giveaway.image.file_name)} />
              </TouchableHighlight>
              ...
              <View style={{flex: 1, flexDirection: 'row'}}>
                ...
                <View
                  ...
                  <Text
                    ...
                    {moment.unix(giveaway.end_time).fromNow(true)}
                  </Text>
                </View>
              </View>
            </View>
