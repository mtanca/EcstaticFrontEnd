    ...
    return (
      <View style={styles.gridItem}>
        ...
        <View style={{flexDirection: 'row', flexWrap: 'wrap'}}>
          <Text style={{flex: 1, justifyContent: 'flex-start'}}>{giveaway.user.first_name}</Text>
    ...
    return(
      <ScrollView>
        ...
        <ScrollView>
          ...
          {
            this.state.hasData &&
            <HomeScreenNew hasData={this.state.hasData} data={this.state.data} navigation={this.props.navigation}/>
          }
          <View style= {{marginTop: '5%', flex: 1, flexDirection:'row'}}>
            <Text style={{marginLeft: 15, fontWeight: 'bold', fontSize: 20}}>Ongoing</Text>
            <View style={{flex: 1, justifyContent: 'flex-end', flexDirection:'row'}}>
              <Text style={{marginRight: 15, color: "#39f3bb", fontWeight: 'bold', fontSize: 15, textAlignVertical: 'center'}}>See all</Text>
            </View>
          </View>
          <View style={{marginLeft: 15}}>
            <Text style={{color: "#798498"}}>Discover all these incredible experiences</Text>
          </View>
